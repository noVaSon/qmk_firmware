...
/*
* Nav Layer: movement and mouse control
*/
    [_NAV] = LAYOUT(
      _______, C(KC_LEFT), KC_PGDN, KC_PGUP, C(KC_RGHT), KC_HOME,                                       _______, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, KC_ACL0,
      _______, KC_LEFT, KC_DOWN,    KC_UP, KC_RGHT,      KC_END,                                        _______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_ACL1,
      _______, KC_UNDO, KC_CUT,     KC_COPY, KC_PSTE,    KC_AGIN, _______, _______,   _______, _______, KC_PGDN, _______, KC_BTN3, _______,  _______, KC_ACL2,
                                 _______, _______,      _______, KC_SCLN, KC_EQL,    KC_EQL,  KC_SCLN, _______, KC_BTN2, KC_BTN1
  ),
